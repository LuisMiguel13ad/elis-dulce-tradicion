...
export function OwnerCalendar({ orders, onOrderClick }: OwnerCalendarProps) {
        ...
        <div className="flex flex-col h-full bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden font-sans">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-white sticky top-0 z-20">
                ...
                <div className="flex items-center gap-3">
                    ...
                    {/* Owner Accent Button */}
                    <Button className="bg-[#C6A649] hover:bg-[#b0933f] text-white gap-2 rounded-lg">
                            ...
                            return (
                                <div key={day.toISOString()} className="flex flex-col min-w-[120px] bg-white group">
                                    ...
                                    <div className={cn(
                                        ...
                                        isToday && "bg-orange-50/50" // Owner Accent Background
                                    )}>
                                        <span className={cn(
                                            "text-xs font-medium mb-1",
                                            isToday ? "text-[#C6A649]" : "text-gray-500" // Owner Accent Text
                                        )}>
                                        ...
                                        <div className={cn(
                                            ...
                                            isToday
                                                ? "bg-[#C6A649] text-white shadow-md shadow-[#C6A649]/20" // Owner Accent Circle
                                        ...
                                        {dayOrders.map(({ order, top, height }) => (
                                            <motion.div
                                                ...
                                                className={cn(
                                                    ...
                                                    /* Styling based on status, using gold/orange/dark accents */
