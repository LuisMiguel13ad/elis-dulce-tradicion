...
export function Features() {
  ...
  const features = [
    ...
    },
    {
      ...
      statLabel: 'Keep your loved ones safe',
    },
  ];
            ...
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
              <CardContent className="relative m-auto size-fit pt-6">
                ...
                <h2 className="mt-6 text-center text-3xl font-semibold text-foreground">
                  {t(features[0].titleES, features[0].titleEN)}
                </h2>
              </CardContent>
            </Card>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-border before:absolute before:-inset-2 before:rounded-full before:border before:border-border/50">
                  <Award className="m-auto h-6 w-6 text-primary" strokeWidth={1} />
                </div>
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  <h2 className="text-lg font-medium text-foreground transition">
                    {t(features[1].titleES, features[1].titleEN)}
                  </h2>
                  <p className="text-muted-foreground">
                    {t(features[1].descES, features[1].descEN)}
                  </p>
                </div>
              </CardContent>
            </Card>

            {/* Third Feature Card - Large with chart */}
            <Card className="relative col-span-full overflow-hidden lg:col-span-2">
              <CardContent className="pt-6">
                <div className="pt-6 lg:px-6">
                  <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-border before:absolute before:-inset-2 before:rounded-full before:border before:border-border/50">
                    <Users className="m-auto h-6 w-6 text-primary" strokeWidth={1} />
                  </div>
                </div>
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  <h2 className="text-lg font-medium text-foreground transition">
                    {t(features[2].titleES, features[2].titleEN)}
                  </h2>
                  <p className="text-muted-foreground">
                    {t(features[2].descES, features[2].descEN)}
                  </p>
                </div>
              </CardContent>
            </Card>
